...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EvilCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"104.236.89.11", "104.236.89.11"},
	{"192.241.198.44", "192.241.198.44"},
	{"104.236.60.15", "104.236.60.15"},
	{"45.55.157.54", "45.55.157.54"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EvilCoin is probably already running."), addrBind.ToString().c_str());
        else
